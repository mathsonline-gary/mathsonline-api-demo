...
{
    protected string $routeName = 'api.v1.students.update';
    ...
    public function test_a_guest_is_unauthenticated_to_update_details_of_a_student()
    {
        ...
        $response = $this->putJson(route($this->routeName, ['student' => $student]), $this->payload);

        // Assert that the response has a 401 “Unauthorized” status code.
        $response->assertUnauthorized();
    }

    public function test_a_teacher_in_an_unsubscribed_school_cannot_update_details_of_a_student()
    {
        {
            $school = $this->fakeTraditionalSchool();
